                        ...
                        <div class="info-w3pvt-mid text-center px-lg-5">
                            <div class="title-desc text-center px-lg-5">
                                ...
                                <p class="px-lg-5">
                                    ...
                                    dui turpis. Praesent ullamcorper dui turpis.At vero eos et accusam et justo duo
                                    dolores et ea rebum.Integer sit amet mattis quam, sit amet ultricies velit. Praesent
                                    ullamcorper dui turpis.
                                </p>
                                <a class="btn mt-lg-4 mt-3 read scroll" href="#services" role="button">
                                    Learn More
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="container py-md-5">
                        ...
                        <div class="row ab-info">
                            ...
                            <div class="col-md-6 ab-content ab-content1">
                                <div class="ab-content-inner">
                                    <a href="single.html">
                                        <img src="assets/images/services1.jpg" alt="news image" class="img-fluid" />
                                    </a>
                                    <div class="ab-info-con">
                        ...
                        <div class="row ab-info second mt-lg-4">
                            <div class="col-md-3 ab-content">
                                <div class="ab-content-inner">
                                    <a href="single.html">
                                        <img src="assets/images/ser3.jpg" alt="news image" class="img-fluid" />
                                    </a>
                                    <div class="ab-info-con">
                                        <h4>colouring</h4>
                                        <a href="single.html" class="read-more two btn m-0 px-3">
                            ...
                            <div class="col-md-3 ab-content">
                                <div class="ab-content-inner">
                                    <a href="single.html">
                                        <img src="assets/images/ser4.jpg" alt="news image" class="img-fluid" />
                                    </a>
                                    <div class="ab-info-con">
                                        <h4>Bathing</h4>
                                        <a href="single.html" class="read-more two btn m-0 px-3">
                            ...
                            <div class="col-md-3 ab-content">
                                <div class="ab-content-inner">
                                    <a href="single.html">
                                        <img src="assets/images/ser5.jpg" alt="news image" class="img-fluid" />
                                    </a>
                                    <div class="ab-info-con">
                                        <h4>drying</h4>
                                        <a href="single.html" class="read-more two btn m-0 px-3">
                            ...
                            <div class="col-md-3 ab-content">
                                <div class="ab-content-inner">
                                    <a href="single.html">
                                        <img src="assets/images/ser6.jpg" alt="news image" class="img-fluid" />
                                    </a>
                                    <div class="ab-info-con">
                                        <h4>Creams</h4>
                                        <a href="single.html" class="read-more two btn m-0 px-3">
                    ...
                    <div class="container py-md-5">
                        <div class="test-info text-center">
                            <h3 class="tittle order">
                                <span>CALL US TO BOOK An APPOINTMENT</span>Our team will call back immediately and Book
                                the Appointment
                            </h3>
                    ...
                    <div class="container py-md-5">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-4 test-grid text-left px-lg-3">
                                <div class="test-info">
                                    <p>
                                        Lorem Ipsum has been the industry's standard since the 1500s. Praesent
                                        ullamcorper dui turpis.
                                    </p>
